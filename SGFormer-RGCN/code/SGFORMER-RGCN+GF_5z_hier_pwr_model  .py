    ...
    for fold, (train_idx, test_idx) in enumerate(kfold.split(dataset_list)):
        ...
        for epoch in range(500):
            ...
            if train_mape < min_train_mape:
                ...
                }, os.path.join(model_dir, f'{target[tar_idx]}_fold{fold + 1}__sgformer-rgcn+gf_5z_mae_h64_checkpoint_train.pt'))
            ...
            if test_mape < min_test_mape:
                ...
                }, os.path.join(model_dir, f'{target[tar_idx]}_fold{fold + 1}__sgformer-rgcn+gf_5z_mae_h64_checkpoint_test.pt'))
