    ...
    for fold, (train_idx, test_idx) in enumerate(kfold.split(dataset_list)):
        ...
        for epoch in range(500):
            ...
            if train_mae < min_train_mae:
                ...
                }, os.path.join(model_dir, f'{target[tar_idx]}_fold{fold + 1}_sage+gf_5z_mae_h64_checkpoint_train.pt'))
            ...
            if test_mae < min_test_mae:
                ...
                }, os.path.join(model_dir, f'{target[tar_idx]}_fold{fold + 1}_sage+gf_5z_mae_h64_checkpoint_test.pt'))
